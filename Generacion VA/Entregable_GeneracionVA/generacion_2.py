...
def main():
  ...
  duracion_esperada_hora = [int(duracion_esperada/60), int(duracion_esperada%60)]
  ...
  print(f'La duración esperada de la ruta es: {duracion_esperada_hora[0]} horas con {duracion_esperada_hora[1]} minutos')
